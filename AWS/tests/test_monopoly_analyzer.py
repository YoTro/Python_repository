...
def test_analyze_review_barrier(analyzer):
    ...
    low_disparity_products = [
        {"rank": i, "review_count": 1000 if i <= 10 else 800, "rating": 4.1} for i in range(1, 60)
    ]
...
def test_full_analysis_integration(analyzer):
    ...
    keyword_data = {"top_asins": [{"clickShare": 0.20}, {"clickShare": 0.15}, {"clickShare": 0.10}]}
