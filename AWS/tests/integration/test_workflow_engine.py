...
from src.jobs.manager import JobStatus, get_job_manager
...
async def test_workflow_execution():
    steps = [DummyStep("step_1", multiplier=2), DummyStep("step_2", multiplier=3)]
...
async def test_workflow_fatal_error():
    steps = [DummyStep("step_1", multiplier=2), DummyStep("step_fail", fail_type="fatal")]
