...
class CPSCRecallProvider:
    ...
    async def search_recalls(self, keyword: str) -> list[dict[str, Any]]:
        ...
        params = {"format": "json", "RecallTitle": keyword}
        ...
        for item in data:
            try:
                ...
                res = {
                    ...
                    "manufactured_in": item.get("ManufacturerCountries", [{}])[0].get(
                        "Country", ""
                    ),
                }
    ...
    def _parse_detail(self, html: str) -> dict[str, Any]:
        ...
        detail["sold_exclusively_online"] = extract_field("仅在网上销售:") or extract_field(
