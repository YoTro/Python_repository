...
class SalesExtractor(AmazonBaseScraper):
    ...
    def extract_sales_from_search(self, keyword: str, page: int = 1) -> list:
        """
    ...
    def get_sales_data(self, keyword: str, page: int = 1) -> list:
        """
        Higher level function returning structured data for CSV saving.
        """
        asins = self.extract_sales_from_search(keyword, page)
