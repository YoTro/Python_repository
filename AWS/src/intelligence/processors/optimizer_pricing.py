...
from src.mcp.servers.finance.tools import estimate_fba_fee_from_dims, get_referral_rate
            ...
            return {
                ...
                "recommendation": {
                    ...
                    "unit_metrics": {
                        ...
                        "net_profit_per_unit": round(
                            best_price - base_cost - (best_price * best_ref_rate) - fba_fee, 2
                        ),
                    },
                },
