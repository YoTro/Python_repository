...
if TYPE_CHECKING:
    from src.intelligence.dto import BatchJobHandle, BatchRequest
...
class BaseLLMProvider(ABC):
    ...
    def create_response(
        self, text: str, input_tokens: int, output_tokens: int, **kwargs
    ) -> LLMResponse:
        """
        ...
        if thought_tokens:
            metadata["thoughts_tokens"] = thought_tokens
        if cached_tokens:
