...
class ErrorCode(str, Enum):
    ...
    AUTH_SCOPE_INVALID  = "auth.scope_invalid"   # Amazon Ads: no matching advertiser / not authorized for scope
    ...
    # ── Billing ───────────────────────────────────────────────────────────────
    BILLING_INSUFFICIENT = "billing.insufficient_balance"  # HTTP 402 (DeepSeek); HTTP 406 (Gemini Exchange)
